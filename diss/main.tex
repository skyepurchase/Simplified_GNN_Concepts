...
\begin{enumerate}[nolistsep]
    \item Splicing together two GNNs to gain the benefit of both architectures. In this case using linear and linear GNNs to produce and efficient, high-accuracy model.
