...
where $d_i$ is the degree of node $v_i$, $d_i = \sum_j^N \emA_{i,j}$, $\theta_i^l$ is a learnable parameter, and $\sigma$ is an activation function.
...
\begin{equation}
    F(\mH^l, \mA) = (\mD + 1)^{-\frac12}(\mA + \mI)(\mD + 1)^{-\frac12}\mH^l.
\end{equation}
...
\begin{equation}
    \label{eq:GCN2}
    \mZ = (\mI + \mD^{-\frac12}\mA\mD^{-\frac12})\mH\bm{\Theta}
\end{equation}
