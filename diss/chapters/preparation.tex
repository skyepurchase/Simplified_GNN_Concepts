...
As \Sref{sec:GCN} demonstrates, a GCN model can be broken down into individual layers, containing a linear graph filter, stacked together using a non-linear activation function.
...
As described in \Sref{sec:GRL} there are two different classification datasets of interest:
...
To produce meaningful results that reflect real-world applications of GNNs two additional real-world datasets are used.
...
\footnotetext[10]{tqdm is distributed under both the MIT and MPL licenses.}
