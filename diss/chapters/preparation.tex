...
Computation of the eigendecomposition of $\mL$ may be too expensive for large graphs and so \textit{Hammond et al.}\cite{hammond2011wavelets} suggest using Chebyshev polynomials\note{maybe appendix}.
...
Extensions presented in \Sref{sec:extensions-imp} and \Sref{sec:extension-eval} address and aim to fix this issue.
