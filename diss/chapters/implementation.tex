...
To generate the example subgraphs, the neighbourhood of nodes closest to a cluster centroid are \error{find a better phrase!}.
...
Furthermore, the benefit of SGC is to reduce the complexity of GCN and pre-compute the graph operation.
Though very small datasets have little improvement in cost or reduction in parameters this is not the case for larger datasets.
...
The repository structure for my project.
