...
SGC may be able to identify basic graph structure, as shown in concepts 1 and 2, but concept 1 highlights the inability for SGC to determine which part of the graph structure a node is.
...
GCN always treats the two communities different regardless of structural similarity which is clear in concepts D and E compared to concept 3.

Overall SGC is able to infer basic graph structure or communities but is unable to achieve fine-grained awareness.
Though particularly apparent in BA Community these effect the performance on other datasets.
...
In the extreme concept 3 highlights the focus on grouping by atom as chlorine is the main consistent feature across subgraphs.
In comparison, concept C highlights how GCN is able to identify very large structures with two cyclic rings consistently identified.
