...
Note that TUDataset\note{citation needed} and Planetoid\cite{kipf2016semi} use there own train/test splits.
...
Notice the spread out \note{Include the labels please!!} which is also present in the GCN layers in \ref{fig:SGC-GCN-latent-space} and \ref{fig:SGCN-GCN-latent-space}.
