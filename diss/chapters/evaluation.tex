...
Mutagenicity is an outlier, achieving 0.626 compared to the published 0.967, as extracting concepts requires a single forest of graphs be used instead of individual graphs.
...
The purity for BA Community in Table \ref{tab:JSGC-purity} is higher, 9.4 compared to 4.0 and 5.6, but more concepts were considered and BA Community is a very complex graph.
