...
The method adapts automatic concept extraction~\cite{ghorbani2019towards} to GNNs to extract graph concepts.
...
\textit{Magister et al.} apply this method to GCN~\cite{kipf2016semi}, a non-linear GNN, this project applies the method to a linear GNN providing a comparison between the two architectures.
