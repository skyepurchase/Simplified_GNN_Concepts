...
\emph{
    This dissertation explores the effect that simplifying graph neural network (GNN) architectures through linearisation has on performance and graph structure awareness.
