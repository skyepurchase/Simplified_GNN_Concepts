...
All these methods are analysed in the framework of concepts to better understand and demonstrate how approaches to graph data and structure manifest themselves.
