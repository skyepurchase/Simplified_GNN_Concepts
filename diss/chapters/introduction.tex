...
It is using these metrics that I compare an SGNN to a GNN as well as confirming that performance matches.
...
This project extends the work of \textit{Magister et al.} \cite{magister2021gcexplainer} to SGC \cite{wu2019simplifying} to help answer the questions posed in \Sref{sec:motivation}.
