\begin{table}[h]
    ...
    \begin{tabular}{c|cc}
        ...
        BA Community    & 95.7\% & 86.3\%\tablefootnote{\label{nb:epochs1}Using the same epochs stated in \textit{Magister et al.}\cite{magister2021gcexplainer}. A greater number of epochs yields a value of 95.1\%.} $\pm$ 3.3 \\
